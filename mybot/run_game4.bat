...
call compile.bat
cd C:\Users\WillN\Documents\College\CompetitiveProgramming\Halite3\Halite3Round2
halite.exe --replay-directory replays/ -vvv "java -classpath mybot MyBot" "java -classpath otherbots/V6 MyBot" "java -classpath otherbots/V6 MyBot" "java -classpath otherbots/V6 MyBot" 
rm *.class
cp replays/*.hlt ./
ren *.hlt replay.hlt
